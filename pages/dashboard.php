...
<head>
  ...
  @media (max-width: 768px) {
    .navbar {
      ...
      .map-container {
        width: 100%;
        height: auto; /* Allows it to scale down */
        margin: 0;
        padding: 5px;
      }
      
      /* Adjust sidepanel for mobile: It's already in offcanvas, but ensure content fits */
      #Sidepanel {
        width: 100%;
        height: auto;
      ...
      /* Ensure SVG elements are touch-friendly: No changes to hover, as we'll handle via JS */
      svg .building {
  ...
  <div style="background-color: white; margin-top: -20px;" class="fixed-top">
    <nav class="navbar navbar-expand-lg bg-body-tertiary  " style="padding-bottom: 20px;">
      <div class="container-fluid d-flex align-items-center justify-content-between" style="margin-bottom: -20px;">
        <a class="animate__animated animate__fadeInLeft" href="dashboard.php">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="collapse navbar-collapse animate__animated animate__backInDown">
              <a href="class_sched.php" style="margin-left: 20px; text-decoration:none; color: white;" > 
                Class Schedule
              </a>
            </li>
          ...
          <form role="search" class="d-flex align-items-center collapse navbar-collapse animate__animated animate__backInDown" >
            <input type="search" id="searchInput" class="form-control me-2" aria-label="search" placeholder="Search campus locations..." style="width: 300px; margin-left: 30px; border-radius: 25px;"> 
      ...
      $.ajax({
        ...
        success: function(response) {
          if (response.status === "success" && response.results.length > 0) {
            ...
            const buildingNumber = result.building_number;
            ...
            Swal.fire({
              icon: "warning", 
              title: "Not Found", 
              text: "No building or room matches your search.", 
              timer : 2000, 
        ...
        error: function() {
          Swal.fire("Error", "Search failed due to a server error.", "error");
        }
